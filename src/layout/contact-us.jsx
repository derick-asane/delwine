...
const ContactUs = () => {
  return (
    <div className="h-screen w-full flex justify-evenly items-center">
      <div className="w-[40%] h-full flex flex-col justify-center gap-4 ">
        <div className="flex rounded-lg bg-slate-400 justify-evenly items-center shadow-slate-600">
          ...
          <span className="text-[50px] text-white">delwine@gmail.coms</span>
        </div>
        <div className="flex rounded-lg bg-slate-400 justify-evenly items-center shadow-slate-600">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="text-[50px] text-white">674-016-433</span>
        </div>
      </div>
      <div className="w-[40%]">
        <img src={contact} alt="" />
